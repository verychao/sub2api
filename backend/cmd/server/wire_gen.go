...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	platformUsageFetcher := service.NewPlatformUsageFetcher(httpUpstream)
	...
	accountUsageService := service.NewAccountUsageService(accountRepository, usageLogRepository, claudeUsageFetcher, geminiQuotaService, antigravityQuotaFetcher, platformUsageFetcher, usageCache, identityCache, tlsFingerprintProfileService)
