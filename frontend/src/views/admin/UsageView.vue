...
const accountDistributionMetric = ref<DistributionMetric>('tokens')
...
const allColumns = computed(() => [
  ...
  { key: 'account', label: t('admin.usage.upstreamAccount'), sortable: false },
